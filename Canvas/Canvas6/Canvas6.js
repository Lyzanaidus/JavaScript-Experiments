...
function updateAvatarAnimation() 
{
	...
	if (currentFrameType != -1) 
	{
		...
		xxx = ((xxx + 1) % (cols-3));	//	Sets value of currentFrameNo to the range [0,cols - 1]
		console.log(xxx);
		currentFrameNo = xxx + 3;
...
function boundaryCollision() 
{
	...
	if (avatarYPos >= (maxCanvasHeight - SpriteHeight)) 
	{
		avatarYPos = (maxCanvasHeight - SpriteHeight);
	}
}
